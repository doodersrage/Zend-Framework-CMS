<?php
    ...
    */
    ...
    class CC_Utility {
        ...
        var $login = 'mulletman'; //Username for your account
        var $password = 'YnotP1zza'; //Password for your account
        var $apikey = 'bd962de0-a0b8-4cdc-939e-72b3785b990a'; // API Key for your account.
